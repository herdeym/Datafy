...
namespace SpotifyAPI.Web.Models
{
    ...
    {
        [JsonProperty("artists")] public List<SimpleArtist> Artists { get; set; }
        ...
        [JsonProperty("external_urls")] public Dictionary<string, string> ExternUrls { get; set; }
        ...
        [JsonProperty("restrictions")] public Dictionary<string, string> Restrictions { get; set; }
